...
Environment Variables:
    ...
    Over Streamable HTTP a request can also bring its own datasets and AWS
    keys in headers (X-Focus-Datasets, X-Focus-Version, X-Aws-Access-Key-Id,
    X-Aws-Secret-Access-Key, X-Aws-Session-Token, X-Aws-Region); those are
    read per request and never configured here.
